...
// Description      :   Replace negative numbers with their absolute values
// Input            :   PNODE
// Output           :   void
// Author           :   Prajjwal Dilip Naykawadi
// Date             :   05/02/2026
...
// Description      :   Display elements which are greater than average
// Input            :   PNODE
// Output           :   void
// Author           :   Prajjwal Dilip Naykawadi
// Date             :   05/02/2026
...
// Description      :   Check whether linked list is sorted in ascending order
// Input            :   PNODE
// Output           :   BOOL
// Author           :   Prajjwal Dilip Naykawadi
// Date             :   05/02/2026
...
// Description      :   Display alternate nodes of linked list
// Input            :   PNODE
// Output           :   void
// Author           :   Prajjwal Dilip Naykawadi
// Date             :   05/02/2026
...
// Description      :   display nodes present at every Nth position
// Input            :   PNODE, int
// Output           :   void
// Author           :   Prajjwal Dilip Naykawadi
// Date             :   05/02/2026
...
void DisplayNth(PNODE Head, int pos)
{
    int iCnt = 1;
...
int main()
{
    ...
    printf("Before MakeAbsolute:\n");
    Display(First);

    MakeAbsolute(First);

    printf("After MakeAbsolute:\n");
    Display(First);
    ...
    printf("Nodes at Nth position (N = 2) are : ");
    DisplayNth(First, 2);
