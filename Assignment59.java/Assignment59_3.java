...
/////////////////////////////////////////////////////////////////////////////////////
//
// Function Name    :   DisplaySubDirectories
// Description      :   Displays only subdirectory names from given directory
// Input            :   String (Directory name)
// Output           :   Names of subdirectories
...
{
    public static void DisplaySubDirectories(String dirname)
    {
        ...
        if(fobj.exists() && fobj.isDirectory())
        {
            ...
            System.out.println("\nSubdirectories in directory are :\n");
    ...
    public static void main(String args[])
    {
        ...
        DisplaySubDirectories(dirname);      // Function call
