...
// Description      :   Replace all even elements with 0
// Input            :   PPNODE
// Output           :   void
// Author           :   Prajjwal Dilip Naykawadi
// Date             :   03/02/2026
...
// Description      :   Replace all odd elements with 1
// Input            :   PPNODE
// Output           :   void
// Author           :   Prajjwal Dilip Naykawadi
// Date             :   03/02/2026
...
// Description      :   Multiply each element of linked list by 2
// Input            :   PPNODE
// Output           :   void
// Author           :   Prajjwal Dilip Naykawadi
// Date             :   03/02/2026
...
// Description      :   Display elements present at even position
// Input            :   PNODE
// Output           :   void
// Author           :   Prajjwal Dilip Naykawadi
// Date             :   03/02/2026
...
// Description      :   Display elements present at odd position
// Input            :   PNODE
// Output           :   void
// Author           :   Prajjwal Dilip Naykawadi
// Date             :   03/02/2026
...
int main()
{
    ...
    printf("After replacing even elements:\n");
    Display(First);

    printf("Before replacing odd elements:\n");
    Display(First);

    ReplaceOdd(&First);

    printf("After replacing odd elements:\n");
    Display(First);

    printf("Before multiplying elements by 2:\n");
    Display(First);

    MultiplyByTwo(&First);

    printf("After multiplying elements by 2:\n");
    Display(First);
