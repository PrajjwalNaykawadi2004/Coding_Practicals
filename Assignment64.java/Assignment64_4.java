/*
    ...
    START
        ...
        Create mask for 7th, 8th and 9th bits using hexadecimal
        Perform AND operation between number and mask
        If result is equal to mask
            Display"7th, 8th and 9th bits are ON"
        Else
            Display "7th, 8th and 9th bits are OFF"
    STOP
*/
...
// Description      :   Checks whether 7th, 8th and 9th bits are ON or OFF
// Input            :   int (Number)
...
class BitLogic
{
    ...
    {
        int iMask = 0x000001C0;                // Hex mask for 7th, 8th and 9th bits
