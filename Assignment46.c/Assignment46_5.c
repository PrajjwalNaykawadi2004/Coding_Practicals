...
// Description      :   Display elements greater than given number X
// Input            :   PNODE, int
// Output           :   void
// Author           :   Prajjwal Dilip Naykawadi
// Date             :   28/01/2026
...
{
    printf("Elements greaer than %d are : ",X);
...
// Description      :   Display elements less than given number X
// Input            :   PNODE, int
// Output           :   void
// Author           :   Prajjwal Dilip Naykawadi
// Date             :   28/01/2026
...
// Description      :   Check whether linked list is empty or not
// Input            :   PNODE
...
// Description      :   Replace all negative elements in linked list with zero
// Input            :   PPNODE
// Output           :   void
// Author           :   Prajjwal Dilip Naykawadi
// Date             :   28/01/2026
...
// Description      :   Increment each node data by 1
// Input            :   PPNODE
// Output           :   void
// Author           :   Prajjwal Dilip Naykawadi
// Date             :   28/01/2026
...
int main()
{
    ...
    DisplayGreater(First, 50);

    DisplayLess(First, 50);

    printf("Before replacing negative elements:\n");
    Display(First);

    ReplaceNegative(&First);

    printf("After replacing negative elements:\n");
    Display(First);

    printf("Before incrementing all elements:\n");
    Display(First);
