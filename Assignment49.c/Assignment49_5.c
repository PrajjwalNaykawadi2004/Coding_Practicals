...
// Description      :   Check whether all elements in linked list are positive
// Input            :   PNODE
...
// Description      :   Display elements which are divisible by 3
// Input            :   PNODE
// Output           :   void
// Author           :   Prajjwal Dilip Naykawadi
// Date             :   04/02/2026
...
// Description      :   Count elements which are divisible by 5
// Input            :   PNODE
// Output           :   int
// Author           :   Prajjwal Dilip Naykawadi
// Date             :   04/02/2026
...
// Description      :   Count two-digit numbers in linked list
// Input            :   PNODE
// Output           :   int
// Author           :   Prajjwal Dilip Naykawadi
// Date             :   04/02/2026
...
int main()
{
    ...
    printf("Count of elements divisible by 5 are : %d\n", iRet);

    iRet = CountTwoDigit(First);
    printf("Count of two digit numbers are : %d\n", iRet);
