...
// Description      :   Counts elements greater than given number X
// Input            :   PNODE, int
// Output           :   int
// Author           :   Prajjwal Dilip Naykawadi
// Date             :   27/01/2026
...
// Description      :   Counts elements less than given number X
// Input            :   PNODE, int
// Output           :   int
// Author           :   Prajjwal Dilip Naykawadi
// Date             :   27/01/2026
...
int main()
{
    ...
    iRet = CountGreater(First, 50);
    printf("Number of elements greater than 50 are : %d\n", iRet);

    iRet = CountLess(First, 50);
    printf("Number of elements less than 50 are : %d\n", iRet);
