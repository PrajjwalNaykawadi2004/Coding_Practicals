...
// Description      :   Counts frequency of given elements in linked list
// Input            :   PPNODE, int
// Output           :   int
// Author           :   Prajjwal Dilip Naykawadi
// Date             :   26/01/2026
...
// Description      :   Displays only even elements from linked list
// Input            :   PPNODE
// Output           :   void
// Author           :   Prajjwal Dilip Naykawadi
// Date             :   26/01/2026
...
int main()
{
    ...
    iRet = Frequency(First, 101);
    printf("Frequency of 101 is : %d\n", iRet);
